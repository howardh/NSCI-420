	...
	methods (Static)
		...
		function ret=ALL_TESTS(expName)
			...
			if strcmp(expName, '12mv1211')
				...
				%Tests with unreliable data removed
				ret={'024', '033', '038', '042', '043', '045', ... %Insertion 1
					'046', '048', '049', '050', '053', '054', ... %Insertion 2
					'056', '057', '060', '061', ... %Insertion 4
					'062', '063', '065', '067', '068', ... %Insertion 5
					'070', '071', '073', '076', '077', '078', '080', '081', '082', '083', ... %Insertion 6
					'087', '089', '097', '098', '099', '100', '101', ... %Insertion 7
					'103', '106', '107', '108', '109', ... %Insertion 8
					'110', '111', '114', '116', '117', '118', '119', ... %Insertion 9
					'133', '134', '135', '137', '140', '141', ... %Insertion 11
					'143', '144', '147', '148'}; %Insertion 12
